...
from attrbench.distributed.metrics import DistributedMinimalSubset
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output-file", type=str, default="minimal_subset.h5")
    ...
    ms = DistributedMinimalSubset(get_model, dataset, args.batch_size,
