...
if not path.isfile(path.join(args.data_root, "models", args.dataset, f"{args.model_params}.pt")):
    sys.exit(f"Model {args.model_params} for dataset {args.dataset} not found in {args.data_root}")
...
model_kwargs = {
    "params_loc": path.join(args.data_root, f"models/{args.dataset}/{args.model_params}.pt"),
