from metrics.noise_invariance.noise_perturbed_dataset import NoisePerturbedDataset
...
if __name__ == "__main__":
    from metrics.noise_invariance.noise_perturbed_dataset import NoisePerturbedDataset, generate_noise_perturbed_dataset
