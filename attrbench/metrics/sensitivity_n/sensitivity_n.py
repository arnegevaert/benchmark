...
from attrbench.metrics.sensitivity_n import SensitivityNResult, SensitivityNWorker
...
class SensitivityN(DistributedMetric):
    def __init__(self, model_factory: Callable[[], nn.Module], dataset: AttributionsDataset, batch_size: int,
        ...
        self._result = SensitivityNResult(dataset.method_names, tuple(maskers.keys()),
