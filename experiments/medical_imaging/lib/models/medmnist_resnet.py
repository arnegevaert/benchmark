...
Downloaded from: https://github.com/kuangliu/pytorch-cifar/blob/master/models/resnet.py and
https://github.com/MedMNIST/MedMNIST/blob/main/medmnist/models.py
'''
import torch
...
class MedMnist_ResNet18(ResNet):
    def __init__(self, num_classes, params_loc=None, in_channels = 3):
        ...
        if params_loc:
            ...
            if 'net' in state_dict.keys(): # weights saved from MedMNIST code
