...
class Resnet50(ResNet):
    def __init__(self,num_classes = 10,params_loc=None,pretrained=False):
        if pretrained:
...
if __name__ == '__main__':
    ...
    torch.save(state_dict, 'resnet50_places365.pt')
    model = Resnet50(365,pretrained=False)
    # model =resnet18(False)
    #
    # sd = load_state_dict_from_url(model_urls['resnet18'])
